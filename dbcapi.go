...
var (
	dll = syscall.NewLazyDLL(libdbcapi_dll)
	// dll = syscall.MustLoadDLL(libdbcapi_dll)

	sqlany_affected_rows       = dll.NewProc("sqlany_affected_rows")
	sqlany_bind_param          = dll.NewProc("sqlany_bind_param")
	sqlany_cancel              = dll.NewProc("sqlany_cancel")
	sqlany_clear_error         = dll.NewProc("sqlany_clear_error")
	sqlany_client_version      = dll.NewProc("sqlany_client_version")
	sqlany_client_version_ex   = dll.NewProc("sqlany_client_version_ex")
	sqlany_commit              = dll.NewProc("sqlany_commit")
	sqlany_connect             = dll.NewProc("sqlany_connect")
	sqlany_describe_bind_param = dll.NewProc("sqlany_describe_bind_param")
	sqlany_disconnect          = dll.NewProc("sqlany_disconnect")
	sqlany_error               = dll.NewProc("sqlany_error")
	sqlany_execute             = dll.NewProc("sqlany_execute")
	sqlany_execute_direct      = dll.NewProc("sqlany_execute_direct")
	sqlany_execute_immediate   = dll.NewProc("sqlany_execute_immediate")
	sqlany_fetch_absolute      = dll.NewProc("sqlany_fetch_absolute")
	sqlany_fetch_next          = dll.NewProc("sqlany_fetch_next")
	sqlany_fini                = dll.NewProc("sqlany_fini")
	sqlany_fini_ex             = dll.NewProc("sqlany_fini_ex")
	sqlany_free_connection     = dll.NewProc("sqlany_free_connection")
	sqlany_free_stmt           = dll.NewProc("sqlany_free_stmt")
	sqlany_get_bind_param_info = dll.NewProc("sqlany_get_bind_param_info")
	sqlany_get_column          = dll.NewProc("sqlany_get_column")
	sqlany_get_column_info     = dll.NewProc("sqlany_get_column_info")
	sqlany_get_data            = dll.NewProc("sqlany_get_data")
	sqlany_get_data_info       = dll.NewProc("sqlany_get_data_info")
	sqlany_get_next_result     = dll.NewProc("sqlany_get_next_result")
	sqlany_init                = dll.NewProc("sqlany_init")
	sqlany_init_ex             = dll.NewProc("sqlany_init_ex")
	sqlany_make_connection     = dll.NewProc("sqlany_make_connection")
	sqlany_make_connection_ex  = dll.NewProc("sqlany_make_connection_ex")
	sqlany_new_connection      = dll.NewProc("sqlany_new_connection")
	sqlany_new_connection_ex   = dll.NewProc("sqlany_new_connection_ex")
	sqlany_num_cols            = dll.NewProc("sqlany_num_cols")
	sqlany_num_params          = dll.NewProc("sqlany_num_params")
	sqlany_num_rows            = dll.NewProc("sqlany_num_rows")
	sqlany_prepare             = dll.NewProc("sqlany_prepare")
	sqlany_reset               = dll.NewProc("sqlany_reset")
	sqlany_rollback            = dll.NewProc("sqlany_rollback")
	sqlany_send_param_data     = dll.NewProc("sqlany_send_param_data")
	sqlany_sqlstate            = dll.NewProc("sqlany_sqlstate")
)
